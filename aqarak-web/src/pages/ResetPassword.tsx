...
import { Lock, Loader2, AlertCircle, ArrowRight, CheckCircle, Eye, EyeOff, Home } from 'lucide-react';
      ...
      >
        <div className="max-w-sm mx-auto w-full">
          ...
          {!success ? (
            <>
              <div className="mb-10">
                <h1 className="text-3xl font-bold text-gray-900 mb-3 tracking-tight">Set New Password</h1>
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="relative group">
                    ...
                    <input
                      ...
                      required
                      disabled={!token}
                      className="w-full pl-11 pr-12 py-3 bg-gray-50/50 border border-gray-200 rounded-xl text-gray-900 placeholder:text-gray-400 focus:bg-white focus:border-primary focus:ring-4 focus:ring-primary/10 transition-all outline-none font-medium disabled:opacity-50"
                      placeholder="••••••••"
                    />
                    <button
                      type="button"
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="relative group">
                    ...
                    <input
                      ...
                      required
                      disabled={!token}
                      className="w-full pl-11 pr-4 py-3 bg-gray-50/50 border border-gray-200 rounded-xl text-gray-900 placeholder:text-gray-400 focus:bg-white focus:border-primary focus:ring-4 focus:ring-primary/10 transition-all outline-none font-medium disabled:opacity-50"
                      placeholder="••••••••"
                    />
                  </div>
                </div>
